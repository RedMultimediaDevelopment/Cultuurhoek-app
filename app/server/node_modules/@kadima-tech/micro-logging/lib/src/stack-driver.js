...
exports.stackdriverOptions = void 0;
...
function addLabels(object) {
    ...
    let httpRequest = {
        ...
        requestUrl: object.res?.req?.url || object.req?.url || object.res?.request?.url,
    };
    // remove any blank properties
    httpRequest = Object.fromEntries(Object.entries(httpRequest).filter(([_, v]) => v != null));
    return {
        ...object,
        httpRequest,
    };
...
//# sourceMappingURL=stack-driver.js.map